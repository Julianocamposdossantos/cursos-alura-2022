...
botao.onclick = () => {
	...
	const back = document.querySelectorAll('.background');
	
	for (let i of back) {
		i.classList.toggle('bg-dark');
		i.classList.toggle('campo');
	}

	let fundo = document.querySelector('body');
	const label = document.querySelectorAll('label');

	fundo.classList.toggle('bg-black');
	fundo.classList.toggle('transition');
